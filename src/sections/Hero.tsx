...
export function Hero() {
    return (
        <Section className="pt-32 pb-20 md:pt-40 md:pb-32 bg-background relative overflow-hidden">
            {/* Background Decor */}
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-accent/20 via-background to-background opacity-50 pointer-events-none" />
